 ...
 * @param elementSize size in bytes of the single element
...
/**
 * Appends a single element to the ring buffer. The stored data length will be
 * increased by element size.
 *
 * @param ringBuffer pointer to a \ref RingBuffer structure
 * @return true if the character was added successfully, false otherwise
*/
...
/**
 * Pulls out a single element from the ring buffer. The stored data length will be
 * decreased by element size.
 *
 * @param ringBuffer pointer to a \ref RingBuffer structure
 * @return true if the character was pulled out successfully, false otherwise
*/
